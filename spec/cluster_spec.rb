  ...
  context 'autoscaling group' do
    ...
    it 'uses all private subnets' do
      expect(subject.vpc_zone_identifier.split(','))
          .to(contain_exactly(*output_with_name('private_subnet_ids').split(',')))
    end
